...
class HomeActivity : AppCompatActivity() {
    private val catalogViewModel: BookCatalogViewModel by viewModels()
    ...
    private fun searchBooks() {
        ...
        if (query.isEmpty()) {
            Toast.makeText(this, "Type a title, author, course, or condition to search", Toast.LENGTH_SHORT).show()
            return
        }
        filterBooks(query)
    }
